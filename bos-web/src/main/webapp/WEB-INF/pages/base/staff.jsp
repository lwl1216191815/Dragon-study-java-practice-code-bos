		...
		<div region="center" style="overflow:auto;padding:5px; border：false" >
			<form id="addStaffForm" action="staffAction_add.action" method="post">
				<table class="table-edit" style="width : 80%; align : center">
					...
					<tr>
						<td>姓名</td>
						<td><input type="text" name="name" class="easyui-validatebox" required="required"/></td>
					</tr>
					<tr>
						<td>手机</td>
						<td>
						...
						<input type="text" name="telephone"  data-ooptions="validType:'telephone'" class="easyui-validatebox" required="required"/>
						</td>
					</tr>
					<tr>
						<td>单位</td>
						<td><input type="text" name="station" class="easyui-validatebox" required="required"/></td>
					</tr>
					<tr>
						<td colspan="2">
					...
					<tr>
						<td>取派标准</td>
						<td>
							<input type="text" name="standard" class="easyui-validatebox" required="required"/>  
						</td>
					</tr>
					</table>
			</form>
