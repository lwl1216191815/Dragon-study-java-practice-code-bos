		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" method="post" action="subareaAction_addSubarea.action">
				<table class="table-edit" width="90%" align="center">
					...
					<tr>
						<td>关键字</td>
						<td><input type="text" name="addresskey" class="easyui-validatebox" required="required"/></td>
					</tr>
					<tr>
						<td>起始号</td>
						<td><input type="text" name="startnum" class="easyui-validatebox" required="required"/></td>
					</tr>
					<tr>
						<td>终止号</td>
						<td><input type="text" name="endnum" class="easyui-validatebox" required="required"/></td>
					</tr>
					<tr>
						<td>单双号</td>
						<td>
					...
					<tr>
						<td>位置信息</td>
						<td><input type="text" name="position" class="easyui-validatebox" required="required" style="width:250px;"/></td>
					</tr>
				</table>
			</form>
		</div>
