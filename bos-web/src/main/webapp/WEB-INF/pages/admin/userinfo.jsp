...
<body class="easyui-layout" style="visibility: hidden;">
	...
	<div region="center" style="overflow: auto; padding: 5px;"
		border="false">
		<form id="userForm" method="post" action="userAction_addUser.action">
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
					<td>联系电话</td>
					<td colspan="3">
					<input type="text" name="telephone" id="telephone" required="true" /></td>
				</tr>
				<tr>
					<td>备注:</td>
					<td colspan="3"><textarea style="width: 80%">
	           	    </textarea></td>
				</tr>
				<tr>
					<td>选择角色</td>
					<td colspan="3" id="roleTd"><script type="text/javascript">
						$(function() {
							$
									.post(
											'roleAction_listajax.action',
											function(data) {
												for (var i = 0; i < data.length; i++) {
													...
													$("#roleTd")
															.append(
																	'<input id="'+id+'" type="checkbox" name="roleIds" value="'+id+'">'
																			+ '<label for="'+id+'">'
																			+ name
																			+ '</label>');
												}
