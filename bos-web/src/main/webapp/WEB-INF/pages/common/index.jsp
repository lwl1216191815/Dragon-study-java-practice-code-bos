               ...
               <form id="editPasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td>
                           <input data-options = "validType:'length[4,6]'" id="txtNewPass" type="Password" class="txt01 easyui-validatebox"  required="required"/>
                       </td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td>
                        	<input id="txtRePass" data-options = "validType:'length[4,6]'" type="Password" class="txt01" class="txt01 easyui-validatebox"  required="required"/>
                        </td>
                    </tr>
                </table>
                </form>
