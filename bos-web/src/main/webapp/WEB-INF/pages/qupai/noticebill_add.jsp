...
<body class="easyui-layout" style="visibility: hidden;">
	<div region="north" style="height: 31px; overflow: hidden;" split="false" border="false">
		<div class="datagrid-toolbar">
			...
			<a id="edit" icon="icon-edit" href="${pageContext.request.contextPath }/page_qupai_noticebill.action" class="easyui-linkbutton" plain="true">
			工单操作
			</a>
		</div>
	</div>
	<div region="center" style="overflow: auto; padding: 5px;" border="false">
		<form id="noticebillForm" action="noticebillAction_addNoticebill.action" method="post">
			<table class="table-edit" width="100%" align="center">
				...
				<tr>
					<td>来电号码:</td>
					<td><input id="telephone" type="text" class="easyui-validatebox" name="telephone" required="required" />
					       <script type="text/javascript">
					       $(function(){
